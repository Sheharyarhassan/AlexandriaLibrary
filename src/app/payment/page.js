  ...
  return (
    <div style={{backgroundColor: '#F4F1ED'}}>
      <div className={'block lg:flex'}>
        <div className={'lg:w-[50.2%] w-full'}>
          <div
            className={'max-w-[485px] text-center mx-auto 2xl:pb-[130px] md:pb-[92px] pb-[64px] relative z-10'}
          >
            <img className={'md:pt-[39px] md:pb-[20.35px] pt-[30px] pb-[18px] mx-auto'}
                 src={'/assets/Payment/logo.png'}
                 alt={'Logo'}/>
            <h2
              className={'lg:mb-[18px] mb-[17px] font-bold text-[1.875rem] sm:text-[2.8125rem] text-(--primary) leading-[40px] md:leading-[60px] tracking-normal text-center'}>
              Payment Details
            </h2>
            <p
              className={'text-black font-normal pb-[30px] md:pb-[34px] text-[16px] lg:text-[20px] leading-[30px] tracking-normal text-center'}>
              This is to verify your account <br/>
              <span className={'font-bold'}>you won’t be charged during your free trial.</span>
            </p>
            <div
              className={'flex flex-col text-start rounded-[8px]'}
              style={{backdropFilter: 'blur(45px)'}}>
              <div
                className={'lg:mx-0 mx-[13px] border-[1px] rounded-[9px] border-white border-solid px-[22px] md:px-[24.5px] pt-[20px] pb-[31px]'}>
                {/*Card holder*/}
                <div className="relative w-full">
                  <input className="font-(family-name:--inter) bg-white mb-[7.5px] w-full placeholder:font-normal
                ...
                {/*Card Number*/}
                <div className="relative w-full">
                  <input className="font-(family-name:--inter) bg-white my-[7.5px] w-full placeholder:font-normal
                placeholder:text-[14px] placeholder:text-(--muted) placeholder:leading-[100%] placeholder:tracking-normal
                !border-0 !outline-0 rounded-[9px] px-[10px] py-[13px]" type="number"
                         placeholder="Card Number"/>
                  <button type="button" className="absolute inset-y-0 end-0 flex items-center pe-3">
                    <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.43799 4.68945H16.9677" stroke="#999999" strokeMiterlimit="10" strokeLinecap="round"
                            strokeLinejoin="round"/>
                      <path d="M4.54419 10.9019H6.09716" stroke="#999999" strokeMiterlimit="10" strokeLinecap="round"
                            strokeLinejoin="round"/>
                      <path d="M8.03833 10.9019H11.1443" stroke="#999999" strokeMiterlimit="10" strokeLinecap="round"
                            strokeLinejoin="round"/>
                      <path
                        d="M4.552 1H13.44C16.288 1 17 1.67333 17 4.35901V10.6409C17 13.3266 16.288 13.9999 13.448 13.9999H4.552C1.712 14.0076 1 13.3343 1 10.6486V4.35901C1 1.67333 1.712 1 4.552 1Z"
                ...
                <div className={'flex gap-[14px]'}>
                  ...
                  <div className="relative w-1/2">
                    <input className="font-(family-name:--inter) bg-white my-[7.5px] w-full placeholder:font-normal
                  placeholder:text-[14px] placeholder:text-(--muted) placeholder:leading-[100%] placeholder:tracking-normal
                  !border-0 !outline-0 rounded-[6px] px-[10px] py-[13px]" type="text"
                           placeholder="MM/YY"
                  ...
                  <div className="relative w-1/2">
                    <input className="font-(family-name:--inter) bg-white my-[7.5px] w-full placeholder:font-normal
                placeholder:text-[14px] placeholder:text-(--muted) placeholder:leading-[100%] placeholder:tracking-normal
                !border-0 !outline-0 rounded-[6px] px-[10px] py-[13px]" placeholder={'CVV'} type={'number'}/>
                  </div>
                </div>
                <CountrySelect onSelect={setCountry}/>

                <button
                  className={'text-white mt-[6.5px] mb-[21px] cursor-pointer rounded-[9px] px-[10px] py-[18px] bg-(--primary) w-full font-bold text-[16px] sm:text-[18px] leading-[100%] tracking-[0%}'}
                  style={{boxShadow: '0px 4px 14px 0px #00144F66'}}
                >
                  Start Free Trial for 7 Days
                </button>
                <div
                  className={'w-full flex flex-wrap lg:pe-[27px] lg:ps-[9px] mb-[11px] justify-between'}>
                  <div className={'flex gap-[9px] items-center margin-center'}>
                    <svg width="13" height="16" viewBox="0 0 13 16" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd"
                            d="M11.3829 7.1875V4.8C11.3829 2.15 9.18878 0 6.5 0C3.81122 0 1.61707 2.15 1.61707 4.8V7.1875H0V16H13V7.1875H11.3829ZM3.26585 4.8C3.26585 3.03125 4.70537 1.6 6.5 1.6C8.29463 1.6 9.73415 3.03125 9.73415 4.8V7.1875H3.26585V4.8Z"
                            fill="black"/>
                    </svg>
                    <p
                      className={'font-(family-name:--inter) font-normal text-[13px] tracking-normal leading-[30px]'}>Secure
                      Payments</p>
                  </div>
                  <div className={'margin-center'}>
                    <p
                      className={'font-(family-name:--inter) font-normal text-[13px] tracking-normal leading-[30px]'}>Safe
                      and Secure SSL Encrypted</p>

                  </div>
                </div>
                <div className={'lg:ps-[9px] flex flex-wrap items-center justify-between'}>
                  <button
                    className={'w-[147px] margin-center text-white cursor-pointer rounded-[9px] px-[12px] py-[3px] bg-(--primary) text-[12px] sm:text-[14px] leading-[30px] tracking-normal'}
                    style={{boxShadow: '0px 4px 14px 0px #00144F66'}}
                  >
                    Powered by <span className={'font-semibold'}>stripe</span>
                  </button>
                  <div
                    className={'margin-center lg:w-[251.37px] w-[197.12px] lg:h-[29.24px] h-[26.95px] flex justify-between'}>
                    <img className={'max-w-full h-auto'} src={'/assets/Payment/mastercard.png'} alt={'PaymentLogos'}/>
                    <img className={'max-w-full h-auto'} src={'/assets/Payment/visa.png'} alt={'PaymentLogos'}/>
                    <img className={'max-w-full h-auto'} src={'/assets/Payment/googlepay.png'} alt={'PaymentLogos'}/>
                    <img className={'max-w-full h-auto'} src={'/assets/Payment/applepay.png'} alt={'PaymentLogos'}/>
                    <img className={'max-w-full h-auto lg:inline hidden'} src={'/assets/Payment/paypal.png'}
                         alt={'PaymentLogos'}/>
                  </div>

                </div>
              </div>
              <img className={'mx-auto lg:mt-[31px] mt-[21px]'} src={'/assets/Payment/Frame.png'}
                   alt={'Trustpilot logo'}/>
            </div>
          </div>
        </div>
        <div className={'lg:w-[49.8%] lg:block hidden w-full h-full'}>
          <div
            className={'bg-(--secondary-200) relative w-full h-full'}>
            <h6
              className="mx-auto xl:px-0 px-[20px] max-w-[595px] text-(--primary) font-semibold text-[30px] leading-[140%] tracking-normal pt-[110px] "
            >
              Join
              <img src="assets/Payment/2000.png" alt="2000+"
                   className="ms-[8px] me-[12px] xl:w-[143px] inline w-auto"/>
              early Founders<span className={'xl:inline hidden'}> who have </span>
              <p className={'-mt-[10px] leading-[140%] tracking-normal'}>
                <span className={'inline xl:hidden'}>who have </span>already answered the call to rebuild
                the
